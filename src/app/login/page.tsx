...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen bg-[#14110e] px-6 py-10 text-stone-100">
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl flex-col items-center justify-center gap-10 lg:flex-row lg:items-center lg:justify-between">
        <div className="mb-10 max-w-lg lg:mb-0 lg:flex lg:flex-col lg:justify-center">
        ...
        <div className="w-full max-w-md overflow-hidden rounded-3xl bg-white text-stone-900 shadow-2xl">
